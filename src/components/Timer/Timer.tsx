...
const Timer: React.FC<TimerProps> = () => {
  ...
  return (
    <div>
      {showTimer ? (
        <div className="flex items-center space-x-2 bg-gradient-to-l from-black to-purple-500 p-1.5 cursor-pointer rounded-md border-purple-700 border-2">
          <div className="h-2 flex items-center ">{formatTime(time)}</div>
          <FiRefreshCcw
            className=""
            onClick={() => {
              setShowTimer(false);
        ...
        <div
          className="flex items-center p-1 h-8 hover:bg-purple-900 rounded cursor-pointer"
